...
public class StudentController {
	...
	public String add(@Validated @ModelAttribute @NonNull StudentBook studentBook, RedirectAttributes result, ModelAndView model, RedirectAttributes redirectAttributes) {
		try {
